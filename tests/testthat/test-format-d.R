...
test_that("fmt_new(\"0,d\") can group thousands and zero fill", {
  expect_equal(fmt_new("01,d")$render(0), "0")
  expect_equal(fmt_new("01,d")$render(0), "0")
  expect_equal(fmt_new("02,d")$render(0), "00")
  expect_equal(fmt_new("03,d")$render(0), "000")
  expect_equal(fmt_new("04,d")$render(0), "0,000")
  expect_equal(fmt_new("05,d")$render(0), "00,000")
  expect_equal(fmt_new("06,d")$render(0), "000,000")
  expect_equal(fmt_new("08,d")$render(0), "00,000,000")
  expect_equal(fmt_new("013,d")$render(0), "0,000,000,000,000")
  expect_equal(fmt_new("021,d")$render(0), "000,000,000,000,000,000,000")
  expect_equal(fmt_new("013,d")$render(-42000000), "-000,042,000,000")

})

test_that("fmt_new(\"0,d\") can group thousands and zero fill with overflow", {
  expect_equal(fmt_new("01,d")$render(1), "1")
  expect_equal(fmt_new("01,d")$render(1), "1")
  expect_equal(fmt_new("02,d")$render(12), "12")
  expect_equal(fmt_new("03,d")$render(123), "123")
  expect_equal(fmt_new("05,d")$render(12345), "12,345")
  expect_equal(fmt_new("08,d")$render(12345678), "12,345,678")
  #expect_equal(fmt_new("013,d")$render(1234567890123), "1,234,567,890,123")
})

test_that("fmt_new(\",d\") can group thousands and space fill", {
  expect_equal(fmt_new("1,d")$render(0), "0")
  expect_equal(fmt_new("1,d")$render(0), "0")
  expect_equal(fmt_new("2,d")$render(0), " 0")
  expect_equal(fmt_new("3,d")$render(0), "  0")
  expect_equal(fmt_new("5,d")$render(0), "    0")
  expect_equal(fmt_new("8,d")$render(0), "       0")
  expect_equal(fmt_new("13,d")$render(0), "            0")
  expect_equal(fmt_new("21,d")$render(0), "                    0")
})

test_that("fmt_new(\",d\") can group thousands and space fill with overflow", {
  expect_equal(fmt_new("1,d")$render(1), "1")
  expect_equal(fmt_new("1,d")$render(1), "1")
  expect_equal(fmt_new("2,d")$render(12), "12")
  expect_equal(fmt_new("3,d")$render(123), "123")
  expect_equal(fmt_new("5,d")$render(12345), "12,345")
  expect_equal(fmt_new("8,d")$render(12345678), "12,345,678")
  #expect_equal(fmt_new("13,d")$render(1234567890123), "1,234,567,890,123")
})
...
test_that("fmt_new(\">d\") align right", {
  ...
  expect_equal(fmt_new(">13,d")$render(0), "            0")
  expect_equal(fmt_new(">21,d")$render(0), "                    0")
  expect_equal(fmt_new(">21,d")$render(1000), "                1,000")
  #expect_equal(fmt_new(">21,d")$render(1e21), "                1e+21")
})
...
test_that("fmt_new(\"d\") can format negative zero as zero", {
  expect_equal(fmt_new("1d")$render(-0), "0")
  expect_equal(fmt_new("1d")$render(-1e-12), "0")
})
