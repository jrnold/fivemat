...
test_that("fmt_new(\"s\") handles very small and very large values", {
  ...
  big <- "" # nolint
  expect_equal(fmt_new("s")(.Machine$double.xmax), big)
})

test_that("print.fmt works", {
  expect_is(print.fmt(fmt_new("")), "fmt")
})
