...
test_that("fmt_new(\"n\") uses zero padding", {
  expect_equal(fmt_new("01.0n")(0), "0")
  expect_equal(fmt_new("02.0n")(0), "00")
  expect_equal(fmt_new("03.0n")(0), "000")
  expect_equal(fmt_new("05.0n")(0), "0,000")
  expect_equal(fmt_new("08.0n")(0), "0,000,000")
  expect_equal(fmt_new("013.0n")(0), "0,000,000,000")
