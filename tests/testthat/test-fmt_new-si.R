...
test_that("fmt_new(\"s\", si_prefix = value)(number) formats with the SI prefix appropriate to the specified value", {
...
test_that("fmt_new(\"s\", si_prefix = value)(number) uses yocto for very small reference values", {
...
test_that("fmt_new(\"$,s\", si_prefix = value)(number) formats with the specified SI prefix", {
